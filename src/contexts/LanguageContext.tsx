...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "admin.editTripDesc": "English and Greek fields; rich text is stored as HTML.",
    ...
    "admin.timelineLegacy": "Archive note",
  ...
  gr: {
    ...
    "admin.editTripDesc": "Πεδία στα αγγλικά και ελληνικά· το πλούσιο κείμενο αποθηκεύεται ως HTML.",
