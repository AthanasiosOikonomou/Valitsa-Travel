...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "detail.participation": "Trip participation",
    ...
    "admin.tripParticipationEn": "Trip participation",
    "admin.tripParticipationEl": "Trip participation",
    ...
    "admin.cancel": "Cancel",
    "admin.unsavedCloseTitle": "Unsaved changes",
    "admin.unsavedCloseDescription":
      "You have unsaved changes. Save before closing, or leave without saving.",
    "admin.unsavedCloseKeepEditing": "Keep editing",
    "admin.unsavedCloseDiscard": "Leave without saving",
    "admin.unsavedCloseSaveAndClose": "Save and close",
    "admin.save": "Save",
    "admin.saving": "Saving…",
  ...
  gr: {
    ...
    "detail.participation": "Συμμετοχή στο ταξίδι",
    ...
    "admin.tripParticipationEn": "Trip participation",
    "admin.tripParticipationEl": "Συμμετοχή στο ταξίδι",
    ...
    "admin.unsavedCloseTitle": "Μη αποθηκευμένες αλλαγές",
    "admin.unsavedCloseDescription":
      "Έχετε μη αποθηκευμένες αλλαγές. Αποθηκεύστε πριν κλείσετε ή βγείτε χωρίς αποθήκευση.",
    "admin.unsavedCloseKeepEditing": "Συνέχεια επεξεργασίας",
    "admin.unsavedCloseDiscard": "Έξοδος χωρίς αποθήκευση",
    "admin.unsavedCloseSaveAndClose": "Αποθήκευση και κλείσιμο",
